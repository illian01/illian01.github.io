...
<p align="center"><img src="{{ site.assets_path }}{{page.title}}/{{page.title}}_figure3.png?raw=true" width="100%"></p>
...
<p align="center"><img src="{{ site.assets_path }}{{page.title}}/{{page.title}}_figure4.png?raw=true" width="50%"></p>
...
<p align="center"><img src="{{ site.assets_path }}{{page.title}}/{{page.title}}_figure5.png?raw=true" width="100%"></p>
